<?php     
	/*
	Plugin Name: myStickysidebar 
	Plugin URI: http://wordpress.transformnews.com/plugins/mystickysidebar-sticky-sidebar-for-wordpress-1083
	Description: Simple sticky sidebar implementation. After install go to Settings / myStickysidebar and change Sticky Class to .your_sidebar_class.
	Version: 1.2.3
	Author: m.r.d.a
...
class MyStickysidebarBackend
{
	...
	public function create_admin_page()
	{
		...
		<div class="wrap">
			<?php screen_icon(); ?>
			<h2><?php _e('myStickysidebar Settings', 'mystickysidebar'); ?></h2>       
	...
	{   
		...
		add_settings_section(
			'setting_section_id',
			__("myStickysidebar Options", 'mystickysidebar'),
